...
- Searching - `O(log n)`
  ...
  ![이진검색트리](../../../assets/img/blog/%EC%9D%B4%EC%A7%84%EA%B2%80%EC%83%89%ED%8A%B8%EB%A6%AC.png)
...
- 예외 <br />
  ![이진검색트리2](../../../assets/img/blog/%EC%9D%B4%EC%A7%84%EA%B2%80%EC%83%89%ED%8A%B8%EB%A6%AC2.png)
  - 이 트리에 삽입이나 탐색을 할 때, 노드의 숫자가 증가하는 만큼 삽입 및 탐색의 단계의 숫자도 증가하기 때문에 시간 복잡도가 O(N)이 된다. 이 경우 이진 트리나 이진 탐색 트리를 사용하지 않는 것이 낫다.
