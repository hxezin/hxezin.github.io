...
const contactClass = 'text-xl text-neutral-600';
        ...
        <ul className='flex gap-2'>
          <li>
            <a href='https://github.com/hxezin' target='_blank'>
              <BiLogoGithub className='text-xl text-neutral-500' />
            </a>
          </li>
          <li>
            <a href='mailto:leehxejin@gmail.com' target='_blank'>
              <BiLogoGmail className='text-xl text-neutral-500' />
            </a>
          </li>
        </ul>
        <div className='text-sm text-neutral-500'>© 2023 Hyejin Lee</div>
      </div>
    </footer>
  );
}
